...
class XSpectraInputConverter(RawInputConverter):
    ...
    XSPECTRA_TEMPLATE_MAP = {
        ...
        'pseudos'       : { 'filecore'      : 'pseudos[filecore]',
                            ...
                            # rpaw
                            'r_paw1'        : ('pseudos[r_paw1]', options.get_xspectra_r_paw_component, None), 
                            'r_paw2'        : ('pseudos[r_paw2]', options.get_xspectra_r_paw_component, None), 
                            'r_paw3'        : ('pseudos[r_paw3]', options.get_xspectra_r_paw_component, None), 
                            'r_paw4'        : ('pseudos[r_paw4]', options.get_xspectra_r_paw_component, None), 
        },
